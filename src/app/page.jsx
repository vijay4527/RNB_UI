      ...
      <section id="home" className={styles.section}>
        <div className={styles.homeWrapper}>
          <div className={`homeSlider ${styles.homesections}`}>
            <img src="https://uploads-ssl.webflow.com/5cff83ac2044e22cb8cf2f11/5cffeaf7b3cb0ed2d33f7943_hero.jpg" alt="" />
          </div>
          <div className={`homeSliderReveal ${styles.homesections}`}>
            <img src="https://uploads-ssl.webflow.com/5cff83ac2044e22cb8cf2f11/5d13364599bb70e3560cc4e5_background-min 3.png" alt="" />
          </div>
        </div>
      </section>
